...
import { formatPrice, isNewShoe, pluralize } from "@/helpers/formatter";

function ShoeCard({ shoe, isPlaceholder }: any) {
    ...
    >
      <article>
        <div className={styles.imageWrapper}>
          ...
          {variant === "on-sale" && (
            <div className={`${styles.flag} ${styles.sale}`}>Sale</div>
          )}
          {variant === "new-release" && (
            <div className={`${styles.flag} ${styles.new}`}>Just released!</div>
          )}
        </div>
