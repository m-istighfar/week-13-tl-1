export async function getShoesForCategory(category: string) {
  await delay(10);
...
const SHOES = [
  {
    ...
    numOfColors: 2,
    categories: ["basketball", "skateboarding", "lifestyle", "bestsellers"],
  },
  {
    slug: "tech-challenge",
  ...
  },
  {
    ...
    numOfColors: 1,
    categories: ["training", "lifestyle", "basketball", "skateboarding"],
  },
  {
    slug: "air-jordan-mid",
