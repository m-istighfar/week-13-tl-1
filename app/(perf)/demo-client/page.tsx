...
export default function DemoClientPage() {
  ...
  useEffect(() => {
    fetch("https://api.escuelajs.co/api/v1/products/81")
      .then((res) => res.json())
      .then(setProduct);
  }, []);
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-gray-50 text-gray-900">
      <h1 className="text-2xl font-bold mb-2">⚙️ Client Component</h1>
      <p className="text-gray-600 mb-4">
        Data diambil di browser setelah halaman di-hydrate.
      </p>
